...
local pb = nil --require 'pb'
local protoc = nil--require 'protoc'
-- local io = require "io" 
local crc32 = require "cfadmin.crypt.checksum" 
local lfstool = require "lfs"
...
local function init()
	...
	local path = skynet.getenv("root").."proto/protobuf3"
